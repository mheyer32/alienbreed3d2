...
; bsr protinit
 ...
 move.w #10,PLR1_GunData	; 10 shots pistol
 st PLR1_GunData+7
 clr.b PLR1_GunData+16+7
 clr.w PLR1_GunData+16
 move.b #0,PLR1_GunSelected
 
 move.w #10,PLR2_GunData	; 10 shots pistol
 st PLR2_GunData+7
 clr.b PLR2_GunData+16+7
 clr.w PLR2_GunData+16
...
**********************************
 ...
 move.l PLR2_Obj,a0
 move.w PLR2_sinval,d4
 muls #100,d4
 move.w PLR2_cosval,d5
 muls #100,d5
 
 move.b PLR2_GunSelected,d0
 asl.b #2,d0
 add.b PLR2_GunFrame,d0
 move.b d0,11+64(a0)
...
.okbigstep:
 ...
 move.w #%110111000001,CollideFlags
...
.notnegative:
 ...
 move.l d0,newy
 move.l d0,oldy
 move.l PLR2_height,thingheight
 move.l #40*256,StepUpVal
 tst.b PLR2_Ducked
 beq.s .okbigstep
 move.l #10*256,StepUpVal
.okbigstep:
 ...
 move.w #%010111100001,CollideFlags
...
sideloopGOUR:
 ...
 move.l #CurrentPointBrights,a4
 move.w (a4,d1.w*2),fbr
 move.w (a4,d3.w*2),sbr
