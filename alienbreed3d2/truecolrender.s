...
;	beq	exit_closeall		if failed the close both, exit
	...
	move.l #RAWSCRN,(a0)
	move.l #RAWSCRN+10240*4,4(a0)
	move.l #RAWSCRN+10240*4*2,8(a0)
	move.l #RAWSCRN+10240*4*3,12(a0)
	move.l #RAWSCRN+10240*4*4,16(a0)
	move.l #RAWSCRN+10240*4*5,20(a0)
	move.l #RAWSCRN+10240*4*6,24(a0)
	move.l #RAWSCRN+10240*4*7,28(a0)
...
NEBBIE: ; incbin "nebbieroar"
	ds.l (192/4)*16
 
 SECTION blib,code_f
 
TEXTURES:
 incbin "includes/shadowmaps"
 even
