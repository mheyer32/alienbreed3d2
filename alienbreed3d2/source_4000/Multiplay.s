...
clrmessbuff:
 ...
 move.l #0,PLR2s_yvel
 move.l #0,PLR3s_xspdval
 move.l #0,PLR3s_zspdval
 move.l #0,PLR3s_yvel
 ...
 move.l #0,PLR2_yvel
 move.l #0,PLR3_xspdval
 move.l #0,PLR3_zspdval
 move.l #0,PLR3_yvel
...
; move.l #PLR2_GunData,GunData
 move.b PLR3_GunSelected,GunSelected
waitmaster:
...
okwat:
 ...
 move.l PLR3_xoff,OLDX3
 move.l PLR3_zoff,OLDZ3
...
.okframe:
 ...
 move.b p1_fire,d0
 lsl.w #8,d0
 move.b PLR1QUITTING,d0
 or.b d0,PLR2QUITTING
 or.b d0,PLR3QUITTING
 swap d0
 move.b PLR1_PAUSE,d0
 or.b d0,PLR2_PAUSE
 or.b d0,PLR3_PAUSE
...
PLR2stuff:
 ...
 move.b p2_fire,d0
 lsl.w #8,d0
 move.b PLR2QUITTING,d0
 or.b PLR1QUITTING,d0
 or.b PLR3QUITTING,d0
 swap d0
 move.b PLR2_PAUSE,d0
 or.b d0,PLR1_PAUSE
 or.b d0,PLR3_PAUSE
 jsr RECFIRST
 or.b d0,PLR1_PAUSE
...
; move.w d0,Rand1
 ...
 move.b p3_fire,d0
 lsl.w #8,d0
 move.b PLR3QUITTING,d0
 or.b PLR2QUITTING,d0
 or.b PLR1QUITTING,d0
 swap d0
 move.b PLR3_PAUSE,d0
 or.b d0,PLR1_PAUSE
 or.b d0,PLR2_PAUSE
 jsr RECFIRST
 or.b d0,PLR1_PAUSE
...
; move.b d0,p1_fire
 ...
 move.w PLAYERTHREEHEALTH,d0
 jsr RECFIRST
; move.w d0,PLAYERONEHEALTH

*********************************
* Trigger plr3 into continuing **
 jsr SENDPAR
*********************************
...
PLR3stuff:
 ...
 move.l #PLAYERTHREEAMMO,a6
 move.w (a6,d0.w*2),d0
 move.w d0,Ammo
 movem.l (a7)+,d0-d7/a0-a6

 move.w PLAYERTHREEHEALTH,Energy

 jsr RECPAR
 move.l PLR3s_xoff,p3_xoff
 move.l PLR3s_zoff,p3_zoff
 move.l PLR3s_yoff,p3_yoff
 move.l PLR3s_height,p3_height
 move.w PLR3s_angpos,p3_angpos
 move.w PLR3_bobble,p3_bobble
 move.b PLR3_clicked,p3_clicked
 clr.b PLR3_clicked
 move.b PLR3_fire,p3_fire
 move.b PLR3_SPCTAP,p3_spctap
 clr.b PLR3_SPCTAP
 move.b PLR3_Ducked,p3_ducked
 move.b PLR3_GunSelected,p3_gunselected
...
drawplayer3:
 ...
 move.w #0,scaleval
 move.l PLR3_xoff,xoff
 move.l PLR3_yoff,yoff
 move.l PLR3_zoff,zoff
 move.w PLR3_angpos,angpos
 move.w PLR3_cosval,cosval
 move.w PLR3_sinval,sinval 



 move.l PLR3_ListOfGraphRooms,ListOfGraphRooms
 move.l PLR3_PointsToRotatePtr,PointsToRotatePtr
 move.b PLR3_Echo,PLREcho
 move.l PLR3_Roompt,Roompt
...
; include "ab3:demo/system/keyboard.s"
...
;      12345678901234567890123456789012345678901234567890123456789012345678901234567890
 dc.b 'Player 1 Bites the dust!                '
 dc.b '                                        '
 dc.b 'Player 1 Bites the dust!                '
 dc.b '                                        '

 dc.b 'Player 2 has kicked the bucket!         '
 dc.b '                                        '
 dc.b 'Player 2 has kicked the bucket!         '
 dc.b '                                        '


 dc.b 'Player 3 is history!                    '
 dc.b '                                        '
 dc.b 'Player 3 is history!                    '
 dc.b '                                        '
...
; 
 ...
 move.l #ObjRotated,a2
 move.w (a0),d0
 move.l PLR3_xoff,(a1,d0.w*8)
 move.l PLR3_zoff,4(a1,d0.w*8)
 move.l PLR3_Roompt,a1
 ...
 beq .notbeenshot3
 move.w ImpactX(a0),d3
 add.w d3,PLR3s_xspdval
 move.w ImpactZ(a0),d3
 add.w d3,PLR3s_zspdval
 move.w ImpactY(a0),d3
 ext.l d3
 asl.l #8,d3
 add.l d3,PLR3s_yvel
...
.notbeenshot3
 ...
 move.b PLR3_StoodInTop,ObjInTop(a0)
...
.notdead: 
 ...
 move.b ObjInTop(a0),ObjInTop(a3)
...
; Take a snapshot of everything.
 ...
 move.l PLR3_xoff,d2
 move.l d2,PLR3_oldxoff
 move.l d2,oldx
 move.l PLR3_zoff,d3
 move.l d3,PLR3_oldzoff
 move.l d3,oldz
 move.l p3_xoff,d0
 move.l d0,PLR3_xoff
 move.l d0,newx
 ...
 move.l d1,zdiff
 move.w p3_angpos,d0
 move.w d0,PLR3_angpos
 
 move.l #SineTable,a1
 move.w (a1,d0.w),PLR3_sinval
 add.w #2048,d0
 and.w #8190,d0
 move.w (a1,d0.w),PLR3_cosval
...
.notdouble
 ...
 move.l d1,PLR3_BOBBLEY

 move.l PLR3_height,d4
 sub.l d1,d4
 add.l d1,d0
 ...
 ext.l d3
 move.l d3,xwobble
 move.w PLR3_sinval,d1
 muls d3,d1
 move.w PLR3_cosval,d2
 muls d3,d2
 swap d1
 swap d2
 asr.w #7,d1
...
.okbigstep:
 ...
 move.w PLR3_xoff,newx
 move.w PLR3_zoff,newz
 bra .noteleport
...
.teleport:
 ...
 move.l PLR3_Roompt,a0
 move.w ToTelZone(a0),d0
 move.w ToTelX(a0),PLR3_xoff
 move.w ToTelZ(a0),PLR3_zoff
 move.l PLR3_yoff,d1
 sub.l ToZoneFloor(a0),d1
 move.l ZoneAdds,a0
 move.l (a0,d0.w*4),a0
 add.l LEVELDATA,a0
 move.l a0,PLR3_Roompt
 add.l ToZoneFloor(a0),d1
 move.l d1,PLR3s_yoff
 move.l d1,PLR3_yoff
 move.l d1,PLR3s_tyoff
 move.l PLR3_xoff,PLR3s_xoff
 move.l PLR3_zoff,PLR3s_zoff
...
.noteleport:
 ...
 move.w #%100000000000,wallflags
 move.b PLR3_StoodInTop,StoodInTop
 ...
 tst.b hitwall
 beq.s .nothitanything
 move.w oldx,PLR3_xoff
 move.w oldz,PLR3_zoff
 move.l PLR3_xoff,PLR3s_xoff
 move.l PLR3_zoff,PLR3s_zoff
 bra .cantmove
.nothitanything:
 ...
 clr.b wallbounce
 bsr MoveObject
 move.b StoodInTop,PLR3_StoodInTop
 move.l objroom,PLR3_Roompt
 move.w newx,PLR3_xoff
 move.w newz,PLR3_zoff
 move.l PLR3_xoff,PLR3s_xoff
 move.l PLR3_zoff,PLR3s_zoff
...
.notintop:
 ...
 adda.w #ToZonePts,a0
 sub.l PLR3_height,d0
 move.l d0,PLR3s_tyoff
 move.w p3_angpos,tmpangpos
...
.nobackgraphics:
 ...
 adda.w #10,a0
 move.l a0,PLR3_ListOfGraphRooms
...
CalcPLR3InLine:
 ...
 move.w PLR3_sinval,d5
 move.w PLR3_cosval,d6
 move.l ObjectData,a4
 move.l ObjectPoints,a0
 move.w NumObjectPoints,d7
 move.l #PLR3_ObsInLine,a2
 move.l #PLR3_ObjDists,a3
...
******************************
 ...
 include "ab3:source_4000/MultiAnims"
...
PLR3s_SquishedHeight: dc.l 0

 include "ab3:source_4000/multiPLR1CONTROL.s"
 include "ab3:source_4000/multiPLR2CONTROL.s"
 include "ab3:source_4000/PLR3CONTROL.s"
 include "ab3:source_4000/multiFALL.s"
...
control3:
 ...
 clr.b PLR3_fire
 move.w #0,ADDTOBOBBLE
 move.l #playercrouched,PLR3s_height
 move.w #-80,d0
 move.w d0,STOPOFFSET
 neg.w d0
 add.w TOTHEMIDDLE,d0
...
.nofric:
 ...
 add.w d3,PLR3s_angpos
 add.w d3,PLR3s_angpos
 and.w #8190,PLR3s_angpos
...
.propercontrol:
 tst.b PLR3MOUSE
 beq.s PLR3_nomouse
 bsr PLR3_mouse_control
PLR3_nomouse:
 tst.b PLR3KEYS
 beq.s PLR3_nokeys
 bsr PLR3_keyboard_control
PLR3_nokeys:
; tst.b PLR2PATH
; beq.s PLR2_nopath
; bsr PLR1_follow_path
...
storeval: dc.w 0
 ...
 include "ab3:source_4000/multiCONTROLLOOP.s"
...
PLR3: dc.b $ff
 even
PLR3_energy: dc.w 191
PLR3_GunSelected: dc.w 0
PLR3_cosval: dc.w 0
PLR3_sinval: dc.w 0
PLR3_angpos: dc.w 0
PLR3_angspd: dc.w 0
...
PLR3_Zone: dc.w 0
PLR3_Roompt: dc.l 0
PLR3_FloorSpd: dc.l 0
PLR3_OldRoompt: dc.l 0
PLR3_PointsToRotatePtr: dc.l 0
PLR3_ListOfGraphRooms: dc.l 0
PLR3_oldxoff: dc.l 0
PLR3_oldzoff: dc.l 0
PLR3_StoodInTop: dc.b 0
 even
PLR3_height: dc.l 0
PLR3_RoomBright: dc.w 0
...
PLR3s_zoff: dc.l 0
PLR3s_tyoff: dc.l 0
PLR3s_xspdval: dc.l 0
PLR3s_zspdval: dc.l 0
PLR3s_Zone: dc.w 0
PLR3s_Roompt: dc.l 0
PLR3s_OldRoompt: dc.l 0
PLR3s_PointsToRotatePtr: dc.l 0
PLR3s_ListOfGraphRooms: dc.l 0
PLR3s_oldxoff: dc.l 0
PLR3s_oldzoff: dc.l 0
PLR3s_height: dc.l 0
PLR3s_targheight: dc.l 0
...
*****************************************************************
 *
 include "AB3:source_4000/multiLevelData2"
 *
*****************************************************************
...
ingame:
; incbin "work:temp/newmusic/testonechan"
gameover: 
;incbin "ab3:includes/gameover"
welldone: incbin "ab3:includes/quietwelldone"
