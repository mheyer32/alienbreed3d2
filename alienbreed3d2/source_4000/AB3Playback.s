...
PLAYBACKLOOP:
 ...
 jsr PLR1_keyboard_control
 move.l (a7)+,a0
 
 move.b 3(a0),d7
 and.b #$7f,d7
 beq.s NOMOVEMENT
 move.b d7,TempFrames+1
...
noendd:
 ...
 move.l RECORDPTR,a0
 sub.l #RECORDBUFFER,a0
 cmp.l #$e2d1a-$dc366,a0
 bge end
...
;      0123456789012345
 ...
 dc.b 0
 dc.b ' PSYCHO  MUTANT '
 dc.b 'CYBORG ALIENS VS'
 dc.b 'SEVERAL THOUSAND'
 dc.b ' ROUNDS OF AMMO '
 dc.b 0
 dc.b ' ITS A FIGHT TO '
 dc.b ' THE DEATH AND  '
 dc.b 'THE ODDS ARE ON '
 dc.b '   THEIR SIDE   '
 dc.b 0
 dc.b '                '
 dc.b 'ONLY HEROES NEED'
 dc.b 'APPLY           '
 dc.b '                '
 dc.b 0
 dc.b '                '
 ...
 dc.b 0
 dc.b ' TEAM 17 BRINGS '
 dc.b 'TO YOU THE FIRST'
 DC.B 'TRUE 3D TEXTURE '
 DC.B '  MAPPED WORLD  '
 DC.B 0
 DC.B 'FULL FREEDOM OF '
 DC.B ' MOVEMENT IN ALL'
 DC.B 'THREE DIMENSIONS'
 DC.B '                '
 DC.B 0
 DC.B 'VARIABLE HEIGHT '
 DC.B 'WALLS FLOORS AND'
 DC.B 'CEILINGS        '
 DC.B 'DOORS AND LIFTS '
 DC.B 0
 DC.B 'BUMP MAPPING ON '
 DC.B 'SOME CEILINGS   '
 DC.B 'PERFORATED WALLS'
 DC.B 'FOR FENCES      '
 DC.B 0
 DC.B 'LOADS OF WEAPONS'
 DC.B ' AND SOME TRULY '
 DC.B 'EVIL SMART BOMBS'
 DC.B '                '
 DC.B 0
 DC.B ' TEXTURE MAPPED '
 DC.B ' VECTOR OBJECTS '
...
*****************************************************************
 *
 include "AB3:source/LevelData2.demo"
 *
*****************************************************************
...
EndBaddieGun:
bass: incbin "ab3:sounds/DRUMLOOP1b"
bassend:
bass2: incbin "ab3:sounds/DRUMLOOP2b"
bass2end:
bass3: incbin "ab3:sounds/DRUMLOOP3b"
bass3end:
