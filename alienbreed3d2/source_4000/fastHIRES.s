...
MORECHUNK:
 ...
 move.w CHUNKPROGRESS,d0
 move.l ROUTINES(pc,d0.w*4),a1
 move.l #$dff000,a0
 jsr (a1)
...
.p43	move.l	a1,-(sp)
	...
	move.w	#1,bltsizh(a0)
	move.l	(sp)+,a1
	move.w #4,CHUNKPROGRESS
	rts

.p44	move.l	a1,-(sp)
	move.l	BBuffer,d0
	sub.l	#16,d0
	add.l	ChunkyPixels,d0
	move.l	d0,(bltapt,a0)
	addq.l	#2,d0
	move.l	d0,(bltbpt,a0)
	move.l	#WorkBM,a1
