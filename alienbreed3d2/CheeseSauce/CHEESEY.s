...
DataCacheOn macro
	...
	include work:includes/hardware/intbits.i
...
** execution to continue.
 ...
 include "ab3:CHEESESAUCE/protsetupdecode"
...
**
 ...
 include "ab3:CHEESESAUCE/ProtectionProtection"
 include "macros.i"
 include "ab3:CHEESESAUCE/defs.i"
...
putinpal:
 ...
 move.w #80,SMIDDLEY
 move.l #40*104*4,SBIGMIDDLEY
 move.w #0,STOPOFFSET
 move.w #80,MIDDLEY
 move.l #40*104*4,BIGMIDDLEY
 move.w #0,TOPOFFSET
...
; JSR STOPTIMER
 ...
 include "ab3:CHEESESAUCE/ab3diipatchidr.s"
...
SAVELETTER: dc.b 'd',0
 ...
 include "ab3:CHEESESAUCE/CHUNKY.s"
...
PAUSEOPTS:
 include "ab3:CHEESESAUCE/pauseopts"
...
.nfl
 ...
 move.l #SimpleFloorLine,LineToUse
* 1,2 = floor/roof
 clr.b usewater
 clr.b usebumps
 move.b #0,gourfloor	
...
SplitHeight: dc.l 0
 ...
 include "ab3:CHEESESAUCE/OrderZones"
...
charlines:
 lea 16*40*3(a1),a3 
 move.b (a2),(a1)
 move.b 10(a2),16*40(a1)
 move.b 20(a2),16*40*2(a1)
 move.b 30(a2),(a3)
 move.b 40(a2),16*40(a3)
 move.b 50(a2),16*40*2(a3)
 lea 16*40*3(a3),a3
 move.b 60(a2),(a3)
 move.b 70(a2),16*40(a3)
...
***********************************
 include "ab3:CHEESESAUCE/CD32JOY"
...
******************************
 include "ab3:CHEESESAUCE/objectMove"
 include "ab3:CHEESESAUCE/newAnims"
 include "ab3:CHEESESAUCE/airoutine.s"
******************************
startpass:
...
; The damn thing overlaps the end of this strip.

 sub.w d3,d7	; remaining width.
 move.w d3,FIRSTLEN
 
 cmp.w #32,d7
 ble.s .allintwostrips
...
***********************************
 ...
 asr.w #5,d0
 asl.w #2,d0
 add.w d0,a3	; starting pos.
 
 asl.w #3,d0
 sub.w d0,d3	; modulo 32
 
 neg.w d3
 add.w #32,d3	; remainder in strip
...
gourfloor: dc.w 0
 ...
 include "ab3:CHEESESAUCE/bumpmap.s"
...
PLR2_Ducked: dc.b 0
 ...
 include "ab3:CHEESESAUCE/PLR1CONTROL.s"
 include "ab3:CHEESESAUCE/PLR2CONTROL.s"
 include "ab3:CHEESESAUCE/FALL.s"
...
storeval: dc.w 0
 ...
 include "ab3:CHEESESAUCE/wallchunk.s"
 include "ab3:CHEESESAUCE/newloadfromdisk.s"
 include "ab3:CHEESESAUCE/screensetup.s"
 include "ab3:CHEESESAUCE/CONTROLLOOP.s"
...
nullline:
 ...
 include "ab3:CHEESESAUCE/titlecop.s"
...
SCRNDRAWPT: dc.l PANELSTRIP
;SCRNSHOWPT: dc.l 0

PANELSTRIP: incbin "ab3:includes/smallpanelraw"
