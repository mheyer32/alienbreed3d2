...
scrht	EQU	256
	...
	move.l FASTBUFFER,CHUNKYBUFFER

	move.l 4.w,a6
	
	move.l	#scrwid*scrht,d0
	move.l	#MEMF_CLEAR,d1		;best possible memory
	jsr	_LVOAllocMem(a6)
...
.NOTDONE:
 ...
 jsr	_c2p8_go
	...
	move.b DONEANYTHING,lastDONEANYTHING
	move.b #0,DONEANYTHING
...
exit_false
	...
	include "charles/cpublitter/c2p8.s"
...
BLUR:
 ifne MOTIONBLUR
 incbin "shadowtex/blurfile"
 endc
 
Font: dc.l fontplace

fontplace: incbin "XENFONT.bin"
CHUNKYBUFFER:	dc.l	0
