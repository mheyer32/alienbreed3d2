...
my_timer2:
		...
		jsr	_LVOSubTime(a6)
		move.l	d1,MY_Timer_l
		
		lea     MY_timer_outputstring,a0	;pointer to the buffer
		move.l  MY_Timer_l,d1			;data to convert
		bsr	deci_4
		movem.l	(sp)+,d2/a2/a6
		rts
...
my_timer4:
		...
		jsr	_LVOSubTime(a6)
		move.l	d1,MY_Timer2_l
		
		lea     MY_timer_outputstring2,a0	;pointer to the buffer
		move.l  MY_Timer2_l,d1			;data to convert
		bsr	deci_4
		movem.l	(sp)+,d2/a2/a6
		rts
...
Frame_time:
		...
		move.l  FrameTime_l,d1			;data to convert
		bsr	deci_4
		move.l	MainScreen,a0
		lea	sc_RastPort(a0),a1
		lea	sc_ViewPort(a0),a0
