...
c2p_SetParamsFull1x1Opt030:
c2p_SetParamsFull1x2Opt030:
				move.l	d2,-(sp)
				move.w	#FS_WIDTH,d0
				move.w	Vid_FullscreenRenderHeight_w,d1
				...
				lsr.l	#3,d2
				move.l	d2,c2p1x1_8_c5_030_2_scroffs	; Display (planar) offset
				mulu.w	d0,d1
				move.l	d1,c2p1x1_8_c5_030_2_pixels
				move.l	d1,c2p1x1_8_c5_030_2_pixels_2
				move.l	(sp)+,d2
				rts


c2p_ConvertFull1x1Opt030:
