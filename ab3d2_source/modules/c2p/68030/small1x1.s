...
c2p_SetParamsSmall1x1Opt030:
c2p_SetParamsSmall1x2Opt030:
				move.l	d2,-(sp)
				...
				lsr.l	#3,d2
				add.w	Vid_SmallRenderTopOffset_w,d2 ; top of current small screen
				move.l	d2,c2p1x1_8_c5_030_2_scroffs
				move.l  d1,d2
				mulu.w	d0,d1
				move.l	d1,c2p1x1_8_c5_030_2_pixels
				mulu.w  #BPLX,d2
				move.l  d2,c2p1x1_8_c5_030_2_pixels_2
				move.l	(sp)+,d2
				rts

c2p_ConvertSmall1x1Opt030:
